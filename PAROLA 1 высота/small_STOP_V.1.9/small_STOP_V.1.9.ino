...
if (val < 800)  {
    ...
    if      (val < 100)  opros=0, textN=1; // сверяем переменную, если val меньше 50 возвращаем 1 (первая кнопка)
    else if (val < 350)  opros=0, textN=2; // если val меньше 150 вторая кнопка и т.д.
    else if (val < 600)  opros=0, textN=3; //
    else if (val < 820)  opros=0, textN=4; // 
