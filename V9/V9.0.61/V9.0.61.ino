...
char *msg[] = /// буквы "Ё" нет!Кириллица только большие буквы !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 {"161 RUS",     //0 //
  "СПОКОЙНО",    //1 //
  " ОБГОНЯЙ СВОБОДНО",//2 //на длинном тексте добавляем впереди пробел, чтоб не сливалось с предыдущ фразой
  "СЛЕПИШЬ",    //3/ 
  "ИЗВИНИ",     //4//
  " ПОНЯТЬ И ПРОСТИТЬ",    //5// 
  "ПОДОЖДИ",   //6// 
...
{ /// блок старта (инициализации). самый ПРОБЛЕМАТИЧНЫЙ участок.!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   delay(1017); // копим энергию на "ХОЛДНЫЙ" старт -когда все кондеры разряжены (был долгий перерыв) 
